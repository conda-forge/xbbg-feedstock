...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xbbg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11760&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xbbg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xbbg` can be installed with:

```
conda install xbbg
```

It is possible to list all of the versions of `xbbg` available on your platform with:
...
* [@mbonix](https://github.com/mbonix/)
