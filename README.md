...
Installing `xbbg` from the `conda-forge/label/xbbg_dev` channel can be achieved by adding `conda-forge/label/xbbg_dev` to your channels with:

```
conda config --add channels conda-forge/label/xbbg_dev
conda config --set channel_priority strict
```

Once the `conda-forge/label/xbbg_dev` channel has been enabled, `xbbg` can be installed with `conda`:
...
```
conda search xbbg --channel conda-forge/label/xbbg_dev
```

or with `mamba`:

```
mamba search xbbg --channel conda-forge/label/xbbg_dev
```
...
mamba repoquery search xbbg --channel conda-forge/label/xbbg_dev

# List packages depending on `xbbg`:
mamba repoquery whoneeds xbbg --channel conda-forge/label/xbbg_dev

# List dependencies of `xbbg`:
mamba repoquery depends xbbg --channel conda-forge/label/xbbg_dev
```
